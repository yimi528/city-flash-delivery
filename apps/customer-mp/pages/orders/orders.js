...
function matchesFilter(order, key) {
  ...
  if (key === 'PENDING') return displayStatus === '待接单'
  ...
  if (key === 'ACTIVE') return ['已接单', '取货中', '前往取货', '上门途中', '前往上车点', '配送中', '搬运中', '行程中'].includes(displayStatus)
  return false
}
