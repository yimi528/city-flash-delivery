...
const content = {
  terms: [
    { title: '服务说明', body: '平台提供同城跑腿、代取代买、搬运装卸等信息与履约服务。具体服务范围、费用和预计时间以下单页及订单确认信息为准。' },
    { title: '订单与费用', body: '用户应提供真实、准确的联系人、地址和物品信息。平台报价确认后方可支付；订单取消、退款和附加费用按照下单时展示的规则处理。' },
    { title: '禁止委托物品', body: '不得委托法律法规禁止流通或存在危险性的物品。用户隐瞒物品性质造成损失的，应依法承担相应责任。' },
    { title: '异常与售后', body: '出现延误、损坏、遗失或其他异常时，请保留订单、物品和沟通凭证并通过客服入口发起处理。' },
    { title: '规则更新', body: '平台会在法律法规、业务或产品发生变化时更新协议，并以页面提示等合理方式通知用户。' }
  ],
  privacy: [
    { title: '收集的信息', body: '为完成登录、下单和履约，平台可能处理微信账号标识、联系人、手机号、收发地址、地图选点形成的地址坐标、订单和支付状态。' },
    { title: '使用目的', body: '相关信息仅用于账号登录、地址搜索、距离计算、订单履约、客服售后、安全风控和法律法规要求的处理。' },
    { title: '位置权限', body: '当前版本不申请微信设备定位权限。用户可通过地址搜索、拖动地图选点或手动填写地址完成下单；骑手端暂使用联调模拟位置，正式定位能力将在完成接口审核后启用。' },
    { title: '共享与保存', body: '履约所必需的信息会提供给实际服务人员。平台按照最短必要期限保存信息，并采取访问控制、加密和日志审计等保护措施。' },
  ...
  qualification: [
    ...
    { title: '经营资质', body: '待核验：根据实际经营模式，公开适用的许可证名称、编号、经营区域和有效期。' },
